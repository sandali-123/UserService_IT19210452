			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-8">
						...
						<h5 class="white-text">GadgetBadget is a company who helps the young researches to sell their products via company's online platform. </h5>
